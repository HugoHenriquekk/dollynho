...
const config = {
    serverInfo: {
        ...
        serverName: "Dollynho", /*Server name*/
        serverIp: "dollynho.work.gd", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1310738315967987803" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
